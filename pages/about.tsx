    ...
    <>
      ...
      <main className="main">
        ...
        <Box mx={[2, 2, '20%']} my={[6, 20]}>
          <Heading mt={[10, 6]}>
            <Avatar src='/freelancer_optimized.png' /> Harshith H M
          </Heading>
          <Divider />
          <Box mt={4}>
            <Text fontSize={20}>
          ...
          <HStack mt={4}>
            <Box onClick={() => window.open('https://www.linkedin.com/in/hmharshith/')} mr={4}>
              <svg
            ...
            <Box onClick={() => window.open('https://github.com/hmharshith')}>
